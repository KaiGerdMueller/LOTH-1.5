...
local mymapgenis = 6--nssm.mymapgenis
local mm = 300--nssm.multimobs
...
if mm ~= 0 then
	if mymapgenis == 6 then
	    ...
	    -- SPIDERS
	    mobs:spawn_specific("nssm:black_widow", {"default:fangorndirt","default:mirkwooddirt","default:jungletreeleaves","default:mirkleaves"}, {"air"}, 0, 20, 20, 1200000/mm, 2, -31000, 31000)
	    mobs:spawn_specific("nssm:daddy_long_legs",{"default:fangorndirt","default:mirkwooddirt","default:jungletreeleaves","default:mirkleaves"}, {"air"}, 0, 20, 10, 1200000/mm, 2, -31000, 31000)
	    mobs:spawn_specific("nssm:tarantula", {"default:fangorndirt","default:mirkwooddirt","default:jungletreeleaves","default:mirkleaves"}, {"air"}, 0, 14, 120, 5000000/mm, 1, -31000, 31000)
	    mobs:spawn_specific("nssm:uloboros", {"default:fangorndirt","default:mirkwooddirt","default:jungletreeleaves","default:mirkleaves"}, {"air"}, 0, 20, 20, 1200000/mm, 1, -31000, 31000)

	    -- DUCKS
	    mobs:spawn_specific("nssm:duck", {"default:gondordirt","default:ithiliendirt","default:dunlanddirt"}, {"air"}, 10, 20, 20, 350000/mm, 1, -31000, 20)
	    mobs:spawn_specific("nssm:duckking", {"default:gondordirt","default:ithiliendirt","default:dunlanddirt"}, {"air"}, 10, 20, 300, 5000000/mm, 1, -31000, 20)
	    --mobs:spawn_specific("nssm:enderduck", {"default:brownlandsdirt"}, {"group:flora"}, 0, 10, 45, 900000/mm, 1, -31000, 20)
	    ...
	    mobs:spawn_specific("nssm:spiderduck", {"default:brownlandsdirt"}, {"group:flora"}, 0, 10, 45, 850000/mm, 1, -31000, 20)
	    mobs:spawn_specific("nssm:swimming_duck", {"default:water_source"}, {"default:water_source"}, 0, 20, 60, 45000000/mm, 1, -31000, 20)

	    -- MOUNTAINS
	    mobs:spawn_specific("nssm:echidna", {"default:gondordirt","default:ithiliendirt","default:dunlanddirt"}, {"air"}, 0, 20, 200, 100000000/mm, 1, 22, 31000)
	    ...
	    -- ICE
	    mobs:spawn_specific("nssm:icelamander", {"default:angmarsnow","default:snowblock", "default:ice"}, {"default:snowblock", "default:ice"}, 0, 20, 120, 25000000/mm, 1, -31000, 31000)
	    mobs:spawn_specific("nssm:icesnake", {"default:angmarsnow","default:snowblock", "default:ice", "default:dirt_with_snow"}, {"default:snowblock", "default:ice", "default:dirt_with_snow"}, 0, 20, 30, 6000000/mm, 1, -31000, 31000)
	    mobs:spawn_specific("nssm:white_werewolf", {"default:dirt_with_snow","default:snowblock"}, {"air"}, 0, 20, 60, 9000000/mm, 1, 20, 31000)
	    mobs:spawn_specific("nssm:snow_biter", {"default:angmarsnow","default:snowblock", "default:ice", "default:dirt_with_snow"}, {"default:snowblock", "default:ice", "default:dirt_with_snow"}, 0, 20, 30, 6000000/mm, 1, -31000, 31000)

	    -- FOREST
	    --mobs:spawn_specific("nssm:larva", {"default:fangorndirt","default:mirkwooddirt"}, {"default:tree","default:aspen_tree"}, 0, 20, 40, 200000/mm, 1, -31000, 140)
	    ...
	    -- PINE FOREST
	    mobs:spawn_specific("nssm:pumpboom_small", {"default:angmarsnow", "default:dirt_with_snow","default:snowblock","default:snow","default:ithiliendirt","default:dunlanddirt"}, {"air"}, 0, 20, 30, 600000/mm, 1, -31000, 31000)
	    mobs:spawn_specific("nssm:pumpboom_medium", {"default:angmarsnow", "default:dirt_with_snow","default:snowblock","default:snow","default:ithiliendirt","default:dunlanddirt"}, {"air"}, 0, 20, 30, 800000/mm, 1, -31000, 31000)
	    mobs:spawn_specific("nssm:pumpboom_large", {"default:angmarsnow", "default:dirt_with_snow","default:snowblock","default:snow","default:ithiliendirt","default:dunlanddirt"}, {"air"}, 0, 20, 30, 1000000/mm, 1, -31000, 31000)
	    mobs:spawn_specific("nssm:pumpking", {"default:angmarsnow", "default:dirt_with_snow","default:snow","default:snowblock","default:ithiliendirt","default:dunlanddirt"}, {"air"}, 0, 12, 120, 8000000/mm, 1, -31000, 31000)
	    ...
	    -- MOUNTAINS
	    mobs:spawn_specific("nssm:echidna", {"default:dirt_with_grass"}, {"default:dirt_with_grass"}, 0, 20, 200, 100000000/mm, 1, -1, 31000)
	    mobs:spawn_specific("nssm:manticore", {"default:mordordust_mapgen"}, {"air"}, 0, 20, 10, 1000, 1, -300, 31000)
	...
	-- SKY
	mobs:spawn_specific("nssm:moonheron", {"air"}, {"air"}, 0, 10, 110, 950000000000/mm, 1, 10, 180)
	mobs:spawn_specific("nssm:night_master", {"air"}, {"air"}, 0, 7, 400, 4500000000000/mm, 2, 10, 180)
	mobs:spawn_specific("nssm:phoenix", {"air"}, {"air"}, 10, 20, 400, 10000000000000/mm, 1, 10, 180)
	mobs:spawn_specific("nssm:scrausics", {"air"}, {"air"}, 10, 20, 110, 950000000000/mm, 1, 10, 180)
end
local mm = 1000
mobs:spawn_specific("nssm:morbat1", {"air"},{"default:underworldrack"}, 0, 20, 100, 20000000/mm, 1, -31000)
mobs:spawn_specific("nssm:morbat2", {"air"}, {"default:underworldrack"}, 0, 20, 100, 20000000/mm, 1, -31000)
mobs:spawn_specific("nssm:morbat3", {"air"},{"default:underworldrack"}, 0, 20, 100, 20000000/mm, 1, -31000)
mobs:spawn_specific("nssm:morvy", {"default:underworldrack"}, {"air"}, 0, 20, 120, 18000000/mm, 1, -31000)
mobs:spawn_specific("nssm:morlu",{"default:underworldrack"}, {"air"}, 0, 20, 80, 1200000/mm, 1, -31000)
mobs:spawn_specific("nssm:morde", {"default:underworldrack"}, {"air"}, 0, 20, 50, 350000/mm, 1, -31000)
mobs:spawn_specific("nssm:mordain", {"default:underworldrack"}, {"air"}, 0, 20, 90, 15000000/mm, 1, -31000)
mobs:spawn_specific("nssm:morgut", {"default:underworldrack"}, {"air"}, 0, 20, 50, 15000000/mm, 1, -31000)
